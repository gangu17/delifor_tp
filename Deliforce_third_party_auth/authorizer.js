...
var userPoolId = constant.COGNITO.POOL_ID;
var region = constant.COGNITO.REGION; //e.g. us-east-1
var iss = 'https://cognito-idp.' + region + '.amazonaws.com/' + userPoolId;
//var jwks = require('./jwks.json');
var pems = {
  // '27sXiMEqNFCbjLcW3WssC6pnJgfu07z2RALTt0TydtA=': '-----BEGIN PUBLIC KEY-----\\n9wIDAQAB\n-----END PUBLIC KEY-----\n',
  // 'fU4KJ5DRcu1XWkxN0QP8xKLRCQjw6EHqDKAn3fXOnBU=': '-----BEGIN PUBLIC KEY-----\\nkQIDAQAB\n-----END PUBLIC KEY-----\n'
};
    ...
    if (!pems) {
      ...
      request({
        ...
        if (!error && response.statusCode === 200) {
          ...
          console.log('hello consoling here');
          console.log(pems);
...
module.exports.createPolicy = function (event, principalId, access) {
  console.log('coming here');
  ...
  if (access === permissionC.AUTHORIZE.ALLOW) {
    policy.allowAllMethods(method, resource);
    return policy.build();
  } else {
