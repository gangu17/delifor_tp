...
AWS.config.update({
// "accessKeyId": "AKIAI3TYFZVJA56HKU4A", "secretAccessKey": "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"
});
  ...
  if (constants) {
    ...
    return new Promise((resolve, reject) => {
      ...
      const getParams = {
        ...
        Key: process.env.constantFileName // path to the object you're looking fo
      };
