...
module.exports = {
    ...
    sendBlockStatus: (cb) => {
        cb(null, formResponse(common.BLOCK_DRIVER, {message: "Driver has been blocked by admin"}))
    },
    ...
    driverMandatory: (cb) => {
        cb(null, formResponse(task.DRIVER_MANDATORY, {message: 'Driver is Mandatory'}));
    },
