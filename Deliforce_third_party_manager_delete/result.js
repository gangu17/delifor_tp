...
module.exports = {
  ...
  sendDuplicateEmail: (cb) => {
    cb(null, formResponse(manager.DUPLICTE_EMAIL, {message: 'Duplication of manager email'}));
  },

  sendDuplicatePhone: (cb) => {
    cb(null, formResponse(manager.DUPLICATE_PHONE, {message: 'Duplication of manager phone number'}));
  }
